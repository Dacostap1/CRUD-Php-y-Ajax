...
?>
  ...
  <table id="tabla" class="table table-hover table-responsive text-center table-bordered">
    <thead class="thead-light">
        ...
        <td><button class ="btn btn-warning btn-md" data-toggle="modal" data-target="#Actualizar" name="<?php echo $valor['ID']?>" onclick = "agregarDatos('<?php echo $datos?>')">Editar</td></button>
	    	<td><button class ="btn btn-danger btn-md"  id ="eliminar" name="" onclick = "ConfirmarArchivar(<?php echo $valor['ID']?>)">Archivar</td></button>
        <td><button class ="btn btn-info btn-md" data-toggle="modal" data-target="#ChangeUser" id="change" name="<?php echo $valor['ID']?>">Delegar</td></button>
